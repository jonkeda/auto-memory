...
- [ ] **TC-01 Activation** — Reload window after install → extension activates without errors in `Help → Toggle Developer Tools → Console`
- [ ] **TC-02 Status bar** — Right side of status bar shows `$(database) auto-memory`
- [ ] **TC-03 Status bar click** — Clicking status bar item opens dashboard in editor tab
- [ ] **TC-04 Activity Bar** — Clicking the database icon opens sidebar view "Dashboard"
...
- [ ] **TC-06 Install** — `Auto Memory: Install CLI` copies binary to `installDir()`; success notification shown
...
- [ ] **TC-11 Install status** — Dashboard header shows version, install dir, and PATH strategy
